...
switch ($action)
{
  ...
  ';
        if ($notif == '')
        {
            ...
            echo '<p>Jeder User verpflichtet sich, die <a href="pub.php?d=rules">Regeln</a> einzuhalten.<br />' .
                LF . 'Verstö&szlig;e gegen die Regeln führen zum Ausschluss vom Spiel!</p>' .
                LF;
            echo '</div>' . LF;
        }
  ...
  <tr><th>Land f�r deinen PC:</th><td><select name="country">
  ';
  ...
  ';
    ...
    case 'regsubmit': // ----------------------- RegSubmit --------------------------
        ...
        $badwords = 'admin|king|multi|cheat|fuck|fick|sex|porn|penis|vagina|arsch|hitler|himmler|goebbels|g�bbels|hure|nutte|fotze|bitch|schlampe';
        ...
        if ($nick != '')
        {
            ...
            {
                $e = true;
                $msg .= 'Der Nickname darf bestimmte Wörter nicht enthalten.<br />';
            }
        } else
        {
            $e = true;
        ...
        {
            $e = true;
            $msg .= 'Bitte eine gültige Email-Adresse im Format x@y.z angeben.<br />';
        }
        ...
        if ($e == false)
        {
            ...
            <p>Bitte wähle jetzt, in welchem Land der Erde dein Computer stehen soll. Natürlich nur im Spiel und nicht in echt...</p>
  ...
  ';
    ...
    <p>Das gewählte Land ist schon "voll"! Bitte such dir ein anderes Land aus!</p></div>
    <form action="pub.php?a=regsubmit" method="post">
    ...
    case 'regactivate': // ----------------------- RegActivate --------------------------
        ...
        {
            $gres->simple_message('Ungültiger Registrierungscode!');
        } else
        {
      ...
      ';
                ...
                echo '<p>Herzlichen Glückwunsch!<br />Dein Account wurde aktiviert!<br />Du kannst dich jetzt auf der <a href="./">Startseite</a> einloggen!</p></div>';
    ...
    case 'newpwdsubmit': // ----------------------- NEW PWD SUBMIT --------------------------
        ...
        if (check_email($email) === true)
        {
            ...
            if ($usr !== false)
            {
                if ($email == strtolower($usr['email']))
                {
                    ...
                    if (@mail($email, 'Zugangsdaten f�r HackTheNet', LF .
        ...
        {
            unset($usr);
            simple_message('Email-Adresse ungültig!');
        }
    ...
    case 'deleteaccount': // ----------------------- DELETE ACCOUNT --------------------------
        ...
        if ($x)
        {
            ...
            simple_message('Ungültiger Account-Lösch-Code!');
        break;
