...
{
  //------------------------- NO!!! -------------------------------
  simple_message('Ungültige Anforderung!<br /><span style="font-size:10pt;">(Code: '.$code.')</font>');
}
...
function deletecluster($cid,$silent=false) 
{
  ...
  if($silent===false) simple_message('Der Cluster '.$cid.' wurde gelöscht.<br /><a href="cluster.php?mode=start&sid='.$sid.'">Weiter</a>');
}
