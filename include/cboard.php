...
class cboard
{
    ...
    function listboard($boxid)
    {
        ...
        if ($cnt == 0)
            echo '<p>Es gibt keine Einträge in diesem Ordner.</p>' . "\n";
        else
        {
            if ($admin)
            ...
            echo '<tr>' . LF . '<th>Titel</th>' . LF . '<th>Autor</th>' . LF .
                '<th>Datum</th>' . LF . '<th>Geändert</th>' . LF . '<th>Antworten</th>' . "\n";
            if ($admin)
            ...
            if ($admin)
            {
                ...
                echo '<option value="delete">L�schen</option>';
                if ($boxid != 0)
                ...
                echo '</select> <input type="submit" value="Ausf�hren" /></td>' . LF . '</tr>' .
                    "\n";
            }
            echo '</table>';
            if ($admin)
