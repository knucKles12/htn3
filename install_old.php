...
include('config.php');
if (HTN_INSTALLED) {
  echo "<br>Wenn du HTN 3 neu installieren willst lösche bitte diese Zeile aus deiner config.php:<br><i>\$htn_installed = true;</i>";
	exit;
}
...
<body text="#000000" bgcolor="#FFFFFF" link="#000080" alink="#000080" vlink="#000080">
  ...
  //   echo 'data/_server1/verifyimgs not writable!';
  // }
  // if(!is_writable('data')){
  //   echo "data not writable!";
  // }
  // if(!is_writable('data/_server1')){
  //   echo "data/_server1 not writable!";
  // }
  // echo $step;

  switch ($step) {
      default:
      echo '   <h3>Bitte wählen sie die Standard Sprache aus</h3>'."\n";
